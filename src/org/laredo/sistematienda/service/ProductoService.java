...
public class ProductoService {
    ...
    public void agregarProducto(String nombre, String marca, double precio) throws ProductoException {
        double precioIGV = precio * 1.18;
        Producto producto = ProductoFactory.createProducto(nombre, marca, precioIGV);
        productoRepository.registrarProducto(producto);
    }

    public void agregarProducto(Productos productos) throws ProductoException {
        double precioIgv = productos.getPrecio() * 1.18;
        Producto producto = ProductoFactory.createProducto(productos);
        productoRepository.registrarProducto(producto);
    }
